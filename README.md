...
| ③ | Access basis (consent) | The policy queries the consent-register during evaluation (`policies/dvtp/gbo/consent.rego`), so a revoke takes effect on the next request |
