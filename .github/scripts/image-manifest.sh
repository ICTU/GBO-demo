...
eudi-adapter|.|./services/eudi-adapter/Dockerfile|services/eudi-adapter services/eudi-issuance-server/config/issuance_server.toml.example|linux/amd64|false|eudi-adapter
